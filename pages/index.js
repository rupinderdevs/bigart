  ...
  return (
    <>
      ...
      <div className="z-30 relative items-center justify-center w-full h-full overflow-auto">
        ...
        <div className="absolute inset-0  z-30  flex flex-col items-center my-8 justify-safe lg:justify-center">
          <div
            className="shadow-2xl rounded-lg w-4/5 h-96 bg-cover bg-center bg-[url('../images/bg.jpg')]"
          >
            <div className="grid grid-cols-12 gap-1">
              <div className="relative my-6 pb-40 px-8 col-span-12 sm:col-span-12 sm:mb-12 md:col-span-7 lg:col-span-7 xxl:col-span-7">
